...
class VehiclePIDController(object):
    ...
    def run_step(self, target_speed, waypoint):
        ...
        max_delta = 0.3
        if current_steering > self.past_steering + max_delta:
            current_steering = self.past_steering + max_delta 
        elif current_steering < self.past_steering - max_delta:
            current_steering = self.past_steering - max_delta 
...
class PIDLateralController(object):
    ...
    def _pid_control(self, waypoint, vehicle_transform):
        ...
        return np.clip((self._k_p * _dot) + (self._k_d * _de) + (self._k_i * _ie), -0.7, 0.7)
